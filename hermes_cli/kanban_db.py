    ...
    for attempt in range(2):
        ...
        try:
            ...
            with write_txn(conn, allow_nested=True):
                # Lookup and insert share the same IMMEDIATE writer transaction.
                # Concurrent creators therefore serialize here, and every later
                # writer returns the first non-archived task for this key.
                if idempotency_key:
                    row = conn.execute(
