        ...
        try:
            ...
            if pull_result.returncode != 0:
                ...
                if local_commit_count != 0:
                    ...
                    stash_branch_ready = current_branch == branch
                    if current_branch not in {branch, "HEAD"}:
                    ...
                    if auto_stash_ref is not None:
                        if stash_branch_ready:
                            ...
                            print(
                                f"  Local changes remain safe in stash {auto_stash_ref}; "
                                "restore the original branch before applying it."
                            )
                    sys.exit(1)
