...
# "Web Search & Extract" picker. Bundled web providers live as plugins after
# PR #25182, and this helper is the sole source of truth for the category's
...
def _plugin_web_search_providers() -> list[dict]:
    ...
    Bundled web providers are plugins; this helper is the sole source of
